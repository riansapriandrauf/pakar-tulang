...
<head>
  ...
  <title>SISTEM PAKAR DIAGNOSA PENYAKIT TULANG - certanity Factor</title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="home">
        <img src="./assets/img/tulang.webp" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">SI PAKAR TULANG</span>
      </a>
    </div>
    ...
    <div class="w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?= active_link($queris['page'], 'home') ?>" href="home">
        ...
        <li class="nav-item">
          <a class="nav-link <?= active_link($queris['page'], 'diagnosa-penyakit') ?>" href="diagnosa-penyakit">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-spinner text-warning text-sm opacity-10"></i>
            </div>
  ...
  <main class="main-content position-relative border-radius-lg ">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="logout">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="assets/img/logo.png" class="avatar avatar-sm  w-100">
                      </div>
    ...
    <div class="container-fluid py-4">
      ...
      switch ($_GET['page']) {
          // DATA PENYAKIT 
        case 'data-penyakit':
          include 'view/data-penyakit.php';
          break;

        case 'gejala-penyakit':
          include 'view/gejala-penyakit.php';
          break;
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                made with by
                <a href="home" class="font-weight-bold" target="_blank">Nina</a> FTI Universitas Sembilanbelas November Kolaka
              </div>
            </div>
          </div>
        </div>
